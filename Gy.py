...
if (six.PY2):
    ...
    import urllib.parse
acil = PRANKBOTS.LINE()
acil.login(token="ErUVyLAVqH2KO76NLNFd.D2VQlYYosQVhFJLhyAb7Fq.WXoQRZy3VwKH/JX8RQ2gnzKyN30HHzTCfUv7/dM0Iz8=")
acil.loginResult()
ki = PRANKBOTS.LINE()
ki.login(token="Er9lR5LbRycFJTFb7Wg7.DlqRyKJ45By6qR51/9HR5W.bg2fwHdKbDJHsI+rDWERrpI6+jUIrBoCC6P5fDWy+BQ=")
ki.loginResult()
ki2= PRANKBOTS.LINE()
ki2.login(token="ErBqpWUB1n3NstQCjOuf.XZz8P6CsX90xK88xL2AVVW.t3OJAWFRLVwgya2jh2WZ/ESukC9VtlfumgzcmxrQliA=")
ki2.loginResult()
ki3 = PRANKBOTS.LINE()
ki3.login(token="EruCEAPSSmVpwpBlOPlb.0cO2i9McKyZSokcFO8Tp/W.DSj8i3JlOgBOvbrFpEXvH0Ut4vfbm7wOs1+ByLd9+1w=")
ki3.loginResult()
ki4 = PRANKBOTS.LINE()
ki4.login(token="Ere1I5xL6O9pvIQEpm86.DOIL1aVKKSMDjRg43snenG.xNQM0LNMozIw20DREfrXqSLxqS2MR8msxwAProJ8M/U=")
ki4.loginResult()
ki5 = PRANKBOTS.LINE()
ki5.login(token="ErtQs7dCMlnDyP4JR286.ees0PEP7QMJbESoBkELdrG.s5bKezOUBH+uHR9BSKIKWYFpitkN0hHqcIiYDnc75U8=")
ki5.loginResult()
ki6 = PRANKBOTS.LINE()
ki6.login(token="ErBw4n1vAQJYLcX0Iwt7.ldWF+v3jth8LePDHdyhzDW.KaQXqdyg9eHiixiQIfwYoyYuA6YEcvHXOz8IO98FucA=")
ki6.loginResult()
ki7 = PRANKBOTS.LINE()
ki7.login(token="ErdeVqsEW04LD6924Hgf.VhqF9sCjom5b05hzYthNRW./Q9/KRUCJz64o9gYaFv4oVKn5hZms7/USNmNQGvYxJE=")
ki7.loginResult()
ki8 = PRANKBOTS.LINE()
ki8.login(token="ErkAOekjxwZ4Qj849cK1.V00y9LwhlyQIwGxLjtHHiq.ZMd6rmArQ/KZ9c1DDVIFgcCRirJrgQ/3OnKf8ftJXhw= ")
ki8.loginResult()
ki9 = PRANKBOTS.LINE()
ki9.login(token="Err4REEIAE1aJy5M4d31.hcj9sxaRwlwOuJpWfCWgmq.5NJoJfSLFLTzBZ0YpO48LjNWnxV2VELmXixYZcu3hRc=")
ki9.loginResult()
ki10 = PRANKBOTS.LINE()
ki10.login(token="ErgCKYySbKfmZde6riu1.i8g8p/i/jAwkTIfcVN5Uuq.m+s72HlSHScnjBwnuzx5K1DYNmUtGKjEROYknhJeHMA=")
ki10.loginResult()
print "login success"
reload(sys)
...
admsa = "u776bea2f2c8e4aabc77e394761a07b7d"
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'joingc':"🇲🇨Hai Salam Kenal Semoga Betah Kk\n Jangan Lupa Baca Not \n 🇲🇨No Baper\n🇲🇨No Cinta \n🇲🇨No Tikung\n🇲🇨No Modus",
...
#-----------------------------------------------
                ...
                acil.sendText(msg.to,"🇲🇨Hai Salam Kenal Semoga Betah Kk\n Jangan Lupa Baca Not \n 🇲🇨No Baper\n🇲🇨No Desah \n🇲🇨No Tikung\n🇲🇨No Modus\nOwner Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
            elif "Bc " in msg.text:
